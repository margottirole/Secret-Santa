...
for this_person=1:size(attribute,1)
    ...
    task_instr= strjoin(['Ho Ho Ho! <br/> <br/> This year you have been randomly selected to give a gift (of £10 max) to...  <br/> <br/>' attribute(this_person,2) '<br/> <br/> Good luck! <br/> <br/> PS: This is a computer-generated email, please do not reply <br/> <br/> <img src="C:\Users\margot.tirole\Desktop\bells.jpg">']);
